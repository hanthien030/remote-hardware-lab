...
- [ ] Trace interrogation path hiện tại end-to-end
- [ ] Xác định metadata nào broker đã có thể lấy chắc chắn
- [ ] Thiết kế response probe mở rộng (chip_family, MAC, flash_size, ...)
- [ ] Lưu metadata probe vào backend/devices
- [ ] Device mới vẫn giữ `block + pending_review`
- [ ] Manual retest Batch 5A completed
