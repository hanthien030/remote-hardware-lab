...
### Batch 5B — Admin metadata UI
- [x] Pending Review box hiển thị metadata probe được
- [x] Approved device có cách xem metadata mở rộng
- [x] Admin approve form auto-fill board class khi có detect chắc chắn
- [x] Admin vẫn sửa tay được nếu detect không chắc
- [x] Manual retest Batch 5B completed

### Batch 5C — User-visible information minimization
- [x] Xác định danh sách field admin-only
- [x] Xác định danh sách field user-visible
- [x] Flash Dialog chỉ hiện thông tin cơ bản cho user
- [x] User endpoints không lộ metadata sâu không cần thiết
- [x] Manual retest Batch 5C completed
